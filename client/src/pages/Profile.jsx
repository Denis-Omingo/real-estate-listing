...
import { updateUserFailure, updateUserStart, updateUserSuccess, deleteUserStart, deleteUserSuccess, deleteUserFailure ,signOutUserFailure,
  signOutUserSuccess,
  ...
  const handleShowListings = async () => {
    try {
      ...
      if (data.success === false) {
        ...
        console.log('There was an error in data fetching at handleShowListing')
        return;
      }
      ...
      console.log(`error from function : ${error} a handleshowlisting`)
      setShowListingsError(true);
    }
  };
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <p className='text-green-700'>{updateSuccess ? 'User is updated successfully': ''}</p>
          ...
          <p className="mx-auto text-red-700">{showListingsError ? 'Error showing listing':''}</p>
